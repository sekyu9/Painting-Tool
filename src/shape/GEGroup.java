...
public class GEGroup extends GEShape{
	...
	public GEGroup() {
		...
		dashedLineStroke = new BasicStroke(GEConstants.DEFAULT_DASHDELINE_WIDTH, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND,10,dashes,0);
	}
	...
	public GEShape deepCopy() {
		GEGroup retunShape = new GEGroup();
		for(GEShape shape:shapeList){
			retunShape.addShape(shape.deepCopy());
		}
		return retunShape;
	}
